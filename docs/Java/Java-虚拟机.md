...
- 静态存储：编译的时候**确定**每个数据目标在运行时的存储空间需求
...
栈中存储着数组或对象实例的堆中目标的首地址，而对象实例实际存储在堆中。

<div align="center"> <img src="https://gitee.com/IvanLu1024/picts/raw/84e33274d3cdc0c054e52572c3cdfcec117c7c31/blog/java/jvm/20190602195526.png" > </div>
